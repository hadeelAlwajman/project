...
public class Test {
    public static void main(String[] args) {
        ...
        m.addChild(3,"رغد","عرفات ","محسن","انثى","يمني","3-2-2019","صنعاء","شارع القيادة","الثالث","2-3-2021","منتظم");

        m.viewChild();

        m.editChild(1,"احمد","إياد","صالح","ذكر","يمني","1-12-2020","صنعاء","شارع القيادة","الاول","2-3-2021","منتظم");
        m.editChild(2,"امجد","امين","المهدي","ذكر","يمني","2-1-2021","صنعاء","شارع القيادة","الاول","2-3-2021","منتظم");
